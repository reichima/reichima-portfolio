  ...
  return (
    <div className="w-full max-w-lg overflow-hidden rounded-xl border border-white/20 bg-[#1e1e1e] shadow-2xl">
      <div className="flex items-center gap-2 border-b border-white/10 bg-[#2d2d2d] px-4 py-2">
        ...
        <div className="ml-2 text-xs text-gray-400">profile.ts</div>
      </div>
      <ScrollArea className="h-[300px] w-full p-4">
        <pre className="font-mono text-sm leading-relaxed">
          ...
          <span className="pl-4">
            ...
            <code className="text-green-300">&quot;Web Engineer&quot;</code>,
          </span>
          <br />
          <span className="pl-4">
          ...
          <br />
          <span className="pl-4">
            <code className="text-sky-300">status: </code>
            <code className="text-green-300">&quot;副業募集中&quot;</code>,
          </span>
          <br />
          <span className="pl-4">
